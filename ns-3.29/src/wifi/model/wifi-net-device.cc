...
WifiNetDevice::CompleteConfig (void)
{
  ...
  m_mac->SetForwardGnUpCallback (MakeCallback (&WifiNetDevice::ForwardGnUp, this));
...
void
WifiNetDevice::SetReceiveGnCallback (NetDevice::ReceiveGnCallback cb)
{
  m_forwardGnUp = cb;
}
...
void
WifiNetDevice::ForwardGnUp (uint8_t gn)
{
  m_forwardGnUp (gn);
}
