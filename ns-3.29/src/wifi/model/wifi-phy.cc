...
WifiPhy::ResumeFromSleep (void)
{
  ...
  switch (m_state->GetState ())
    ...
    default:
      {
        //NS_LOG_UNCOND(m_state->GetState());
        NS_ASSERT (false);
        break;
      }
    }
...
{
  //NS_LOG_UNCOND("WifiPhy::SendPacket");
...
{
  //NS_LOG_UNCOND("WifiPhy::StartReceivePreambleAndHeader");
  WifiPhyTag tag;
...
WifiPhy::StartReceivePacket (Ptr<Packet> packet,
                             ...
                             Ptr<Event> event)
{
  //NS_LOG_UNCOND("WifiPhy::StartReceivePacket");
...
{
  //NS_LOG_UNCOND("WifiPhy::EndReceive");
