...
public:
  ...
  vector<Data*> GetDataBuffer (void) const;
  void SetDataBuffer (vector<Data*> dataBuffer);
  void BufferClear (void);
  double GetBufferThreshold (void) const;
  ...
  Mac48Address GetParentMacAddress (void);
  void SetParentMacAddress (Mac48Address parentMacAddress);

  Ipv4Address GetParentIpv4Address (void);
  void SetParentIpv4Address (Ipv4Address parentIpv4Address);
...
private:
  ...
  double m_dataAmount;
  double m_bufferThreshold;

  Ipv4Address m_parentIpv4Address;
  Mac48Address m_parentMacAddress;
  NodeType m_nodeType;
