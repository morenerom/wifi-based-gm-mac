...
public:
  ...
  void SetCreateSocketCallback (Callback<void, Ptr<Node> > createSocket);
  Ptr<Packet> GetCurPacket (void);
...
private:
  Callback<void, Ptr<Node> >                   m_createSocket;         //!< data received callback
  Ptr<Packet> m_curPacket;
  /**
